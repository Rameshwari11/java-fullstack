...
import com.cgi.exception.MovieException;
...
public class LoginController {
    ...
    public ResponseEntity<?> registerUser(@RequestBody SignUpDto signUpDto, 
        ...
        Optional<Role> optRole =  Optional.ofNullable(roleRepository.findByName(roleName)
        		.orElseThrow(() -> new MovieException("Role Not Configured.")));
